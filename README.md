...
1. ddev - ridiculously simple setup for complex development environments
    ...
    1. [.ddev/gitpod-setup-ddev.sh](https://github.com/shaal/ddev-gitpod/blob/main/.ddev/gitpod-setup-ddev.sh) - update ddev setup according to Gitpod requirements.
        1. Delete any existing Docker images and containers (due to Gitpod bug, that cause issues when restarting a workspace)
        1. Set certain ports to public 8080, 8025, and 8036, following Gitpod's syntax `[port]-[workspace-url]`
